...
//修改管理员信息
export const updateAdminInfo = (userId, name, username, password, roleId, cinemaId) => ajax('/admin/auser/updateInfo', { userId, name, username, password, roleId, cinemaId }, 'POST')
