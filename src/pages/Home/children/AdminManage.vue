  ...
  <div id="user-manage">
    ...
    <div class="user-table">
      <el-table border :data="tableData">
        ...
        <el-table-column label="用户名" align="center" width="300" prop="name"></el-table-column>
...
<script>
import { getCurrentPageAdmin, updateAdminInfo, getOptions3 } from '@/api/index.js'
  ...
  methods: {
    ...
    async manageUserInfo() {
      if (this.userInfo.username && this.userInfo.password && this.userInfo.roleId) {
        let json = await updateAdminInfo(this.userInfo.id, this.userInfo.name, this.userInfo.username, this.userInfo.password, this.userInfo.roleId, this.userInfo.cinemaId)
        if (json.state === 200) {
