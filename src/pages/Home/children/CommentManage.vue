  ...
  <div id="comment-manage">
    ...
    <div class="comment-table">
      <el-table border :data="tableData" style="width: 100%">
        <el-table-column label="评论 ID" align="center" width="100" prop="id"> </el-table-column>
        <el-table-column label="用户名" width="120" show-overflow-tooltip prop="userName"> </el-table-column>
        <el-table-column label="电影名" show-overflow-tooltip prop="movieName"> </el-table-column>
        <el-table-column label="评论时间" show-overflow-tooltip prop="calcTime"> </el-table-column>
        <el-table-column label="用户评分" width="80" align="center" prop="sc"> </el-table-column>
