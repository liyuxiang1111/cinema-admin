  ...
  <div id="user-manage">
    ...
    <div class="user-table">
      <el-table border :data="tableData">
        ...
        <el-table-column label="用户名" align="center" width="120" show-overflow-tooltip prop="nickName"></el-table-column>
        ...
        <el-table-column label="最近登录" align="center" width="400" prop="lastLogin" :formatter="formateDate"></el-table-column>
...
<script>
import { getCurrentPageUser, updateUserInfo } from '@/api/index.js'
